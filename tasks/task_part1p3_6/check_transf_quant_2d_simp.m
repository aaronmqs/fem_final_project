...
ndim = 2;
porder = 2;
nquad_per_dim = 6; % More points necessary than "expected" because the integrand "suffers" two different transformations: one from the idealized hypercube to the idealized simplex and another one from the idealized simplex to the physical one.
